...
if __name__ == '__main__':
    ...
    plt.savefig(f"plots/test_{local_test_instance_index}_shap_bar_plot.png", bbox_inches="tight")
    plt.close()
    ...
    for i in [0, 1]:
        ...
        sorted_importances = sorted(sorted_importances, key=lambda x: abs(x[1]), reverse=False)
